...
namespace Storefront.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(StorefrontProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderId,FulfillmentStatus,CustomerId,OrderDate")] Order order)
        {
            ...
            ViewData["CustomerId"] = new SelectList(_context.CustomerData, "CustomerId", "CustomerId", order.CustomerId);
            return View(order);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StorefrontProjectContext.Orders'  is null.");
            }
            var order = await _context.Orders.FindAsync(id);
            if (order != null)
            {
